...
/***/ function(module, exports, __webpack_require__) {
	...
	var StringController = function (_Controller) {
	  ...
	  function StringController(object, property) {
		...
		//cheng_change
	    function onClick() {
	      if (_this.domElement.parentElement.parentElement.parentElement.children[0].innerText != '批注') {
		var InputString = _this.getValue();
		SetMoreInformationDispFontSize(InputString);
                   MoreInformationDisp(InputString);
                   }						
              }
	    ...
	    _dom2.default.bind(_this2.__input, 'click', onClick);
